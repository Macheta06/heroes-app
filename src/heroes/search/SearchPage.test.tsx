...
vi.mock("../actions/search-heros.actions");
const mockSearchHeroesActions = vi.mocked(searchHeroesAction);
...
describe("SearchPage", () => {
  ...
  test("should render SearchPage with default values", () => {
    ...
    expect(mockSearchHeroesActions).toHaveBeenCalledWith({
      name: undefined,
      strength: undefined,
    });
  ...
  test("should render HeroGrid with search results", async () => {
    ...
    mockSearchHeroesActions.mockResolvedValue(mockHeroes);
